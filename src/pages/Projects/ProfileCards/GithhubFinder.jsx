      ...
      <div class="github-Finder-Card pl-4">
        <div class="rounded-lg shadow-lg bg-white max-w-sm shadow-md dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6">
            ...
            A solo project that was developed in React, that uses the github API to find users github profiles and repositories.
            </p>
            <div className="flex">
            <a className="mr-[.5rem]"target="_blank" href= "https://github-finder-firebase.web.app/">
              ...
              <a target="_blank" href="https://github.com/nightzillla/github-finder-firebase">
